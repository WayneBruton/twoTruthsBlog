    ...
    <v-container>
      <v-layout wrap>
        <v-flex mb-5 xs12 md8 offset-md2>
          ...
          <br />
          <p>
            <strong id="subHeading">CONDITIONS OF USE</strong>
          </p>
          <p>
            Welcome to our Vellum!
            <strong>Vellum</strong> and its associates provide their services to
            you subject to the following conditions. If you visit or shop within
            this website, you accept these conditions. Please read them
            carefully.
          </p>
          <p>
            <strong id="subHeading">PRIVACY</strong>
          </p>
          <p>
          ...
          <p>
            <strong id="subHeading">ELECTRONIC COMMUNICATIONS</strong>
          </p>
          <p>
            When you visit
            <strong>Vellum</strong> or send e-mails to us, you are communicating
          ...
          <p>
            <strong id="subHeading">COPYRIGHT</strong>
          </p>
          <p>
            ...
            <strong>Vellum</strong> or its content suppliers and protected by
            international copyright laws. The compilation of all content on this
            site is the exclusive property of <strong>Vellum</strong>, with
            copyright authorship for this collection by <strong>Vellum</strong>,
            and protected by international copyright laws.
          </p>
          <p>
            <strong id="subHeading">TRADE MARKS</strong>
          </p>
          <p>
            <strong>Vellum's</strong> trademarks and trade dress may not be used
            in connection with any product or service that is not
            <strong>Vellum's</strong>, in any manner that is likely to cause
            confusion among customers, or in any manner that disparages or
            discredits <strong>Vellum</strong>. All other trademarks not owned
            by <strong>Vellum</strong> or its subsidiaries that appear on this
            site are the property of their respective owners, who may or may not
            be affiliated with, connected to, or sponsored by
            <strong>Vellum</strong> or its subsidiaries.
          </p>
          <p>
            <strong id="subHeading">LICENSE AND SITE ACCESS</strong>
          </p>
          <p>
            <strong>Vellum</strong> grants you a limited license to access and
            ...
            written consent of <strong>Vellum</strong>. This license does not
            ...
            express written consent of <strong>Vellum</strong>. You may not
            ...
            layout, or form) of <strong>Vellum</strong> and our associates
            without express written consent. You may not use any meta tags or
            any other "hidden text" utilizing <strong>Vellum's</strong> name or
            trademarks without the express written consent of
            <strong>Vellum</strong>. Any unauthorized use terminates the
            permission or license granted by <strong>Vellum</strong>. You are
            granted a limited, revocable, and nonexclusive right to create a
            hyperlink to the home page of <strong>Vellum</strong> so long as the
            link does not portray <strong>Vellum</strong>, its associates, or
            their products or services in a false, misleading, derogatory, or
            otherwise offensive matter. You may not use any
            <strong>Vellum</strong> logo or other proprietary graphic or
            trademark as part of the link without express written permission.
          </p>
          <p>
            <strong id="subHeading">YOUR MEMBERSHIP ACCOUNT</strong>
          </p>
          <p>
            ...
            or guardian. <strong>Vellum</strong> and its associates reserve the
            right to refuse service, terminate accounts, remove or edit content,
            or cancel orders in their sole discretion.
          </p>
          <p>
            <strong id="subHeading"
              >REVIEWS, COMMENTS, EMAILS, AND OTHER CONTENT</strong
            >
          </p>
          <p>
            ...
            origin of a card or other content.
            <strong>Vellum</strong> reserves the right (but not the obligation)
            to remove or edit such content, but does not regularly review posted
            content. If you do post content or submit material, and unless we
            indicate otherwise, you grant <strong>Vellum</strong> and its
            ...
            <strong>Vellum</strong> and its associates and sublicensees the
            ...
            or entity: and that you will indemnify <strong>Vellum</strong> or
            its associates for all claims resulting from content you supply.
            <strong>Vellum</strong> has the right but not the obligation to
            monitor and edit or remove any activity or content.
            <strong>Vellum</strong> takes no responsibility and assumes no
            liability for any content posted by you or any third party.
          </p>
          <p>
            <strong id="subHeading">PRODUCT DESCRIPTIONS</strong>
          </p>
          <p>
            <strong>Vellum</strong> and its associates attempt to be as accurate
            as possible. However, <strong>Vellum</strong> does not warrant that
            ...
            <strong>Vellum</strong> itself is not as described, your sole remedy
            is to make contact with us and together we can attempt to resolve
            the situation..
          </p>
          ...
          <p>
            <strong>
              ...
              PROVIDED BY <strong>Vellum</strong> ON AN "AS IS" AND "AS
              AVAILABLE" BASIS. <strong>Vellum</strong> MAKES NO REPRESENTATIONS
              OR WARRANTIES OF ANY KIND, EXPRESS OR IMPLIED, AS TO THE OPERATION
              OF THIS SITE OR THE INFORMATION, CONTENT, MATERIALS, OR PRODUCTS
              INCLUDED ON THIS SITE. YOU EXPRESSLY AGREE THAT YOUR USE OF THIS
              SITE IS AT YOUR SOLE RISK. TO THE FULL EXTENT PERMISSIBLE BY
              APPLICABLE LAW, <strong>Vellum</strong> DISCLAIMS ALL WARRANTIES,
              EXPRESS OR IMPLIED, INCLUDING, BUT NOT LIMITED TO, IMPLIED
              WARRANTIES OF MERCHANTABILITY AND FITNESS FOR A PARTICULAR
              PURPOSE. <strong>Vellum</strong> DOES NOT WARRANT THAT THIS SITE,
              ITS SERVERS, OR E-MAIL SENT FROM <strong>Vellum</strong> ARE FREE
              OF VIRUSES OR OTHER HARMFUL COMPONENTS.<strong>Vellum</strong>
          ...
          <p>
            By visiting
            <strong>Vellum</strong>, you agree that the laws of South Africa,
            ...
            between you and <strong>Vellum</strong> or its associates.
          </p>
          <p>
            <strong id="subHeading">DISPUTES</strong>
          </p>
          <p>
            Any dispute relating in any way to your visit to
            <strong>Vellum</strong> or to products you purchase through
            <strong>Vellum</strong> shall be submitted to confidential
            arbitration in South Africa, except that, to the extent you have in
            any manner violated or threatened to violate
            <strong>Vellum's</strong> intellectual property rights,
            <strong>Vellum</strong> may seek injunctive or other appropriate
            relief in any court in South Africa, and you consent to exclusive
            jurisdiction and venue in such courts. Arbitration under this
            agreement shall be conducted under the rules then prevailing of the
            American Arbitration Association. The arbitrators award shall be
            ...
            arbitration under this Agreement shall be joined to an arbitratio
            involving any other party subject to this Agreement, whether through
            class arbitration proceedings or otherwise.
          </p>
          <p>
            <strong id="subHeading"
              >SITE POLICIES, MODIFICATION, AND SEVERABILITY</strong
            >
          </p>
          <p>
            ...
            to
            <strong>Vellum</strong>.We reserve the right to make changes to our
          ...
          <p>
            <strong id="subHeading">QUESTIONS:</strong>
          </p>
          <p>
